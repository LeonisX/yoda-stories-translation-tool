...
public class MainStageController {
    ...
    public void closeMenuItemClick(ActionEvent actionEvent) {
    }

    public void exitMenuItemClick(ActionEvent actionEvent) {
    }

    public void transparentColorMenuItemClick(ActionEvent actionEvent) {
    }

    public void addTilesMenuItemClick(ActionEvent actionEvent) {
    }

    public void howToMenuItemClick(ActionEvent actionEvent) {
    }

    public void aboutMenuItemClick(ActionEvent actionEvent) {
    }

    public void openExeFileButtonClick(ActionEvent actionEvent) {
